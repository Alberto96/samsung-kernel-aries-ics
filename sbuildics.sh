...
case "$1" in
        galaxys)
            VARIANT="galaxys"
            VER=""
	    BASE_SEMA_VER="GearKernel_ICS_GalaxyS_1.0.9"
        ...
        galaxysb)
            VARIANT="galaxysb"
            VER="b"
	    BASE_SEMA_VER="GearKernel_ICS_GalaxySB_1.0.9"
        ...
        captivate)
            VARIANT="captivate"
            VER="c"
	    BASE_SEMA_VER="GearKernel_ICS_Captivate_1.0.9"
        ...
        vibrant)
            VARIANT="vibrant"
            VER="v"
	    BASE_SEMA_VER="GearKernel_ICS_Vibrant_1.0.9"
...
echo 
echo "Making ""GearKernelICS"_$VARIANT"_defconfig"

DATE_START=$(date +"%s")

make -j3 "GearKernelICS"_$VARIANT"_defconfig"
